...
On the landing page, Research, Writing, and Projects open as compact card
columns beside the About copy. Their original full-page views remain available
through each panel's **View all** link.

The `?v=28` asset suffix is a simple Safari cache key. Increment it in each HTML
